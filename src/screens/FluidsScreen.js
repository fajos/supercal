...
export default function FluidsScreen() {
  ...
  const handleSolve = () => {
    ...
    setTimeout(() => {
      try {
        ...
        const modeLabels = {
          pressure_solid: 'Solid Pressure',
          pressure_liquid: 'Liquid Pressure'
        };
        const shareText = `Fluids & Pressure Result (${modeLabels[mode]}):\nInput: ${JSON.stringify(params)}\nResult: ${solverResult.result}\n\nSolved with SuperCalc`;
  ...
  const operations = [
    { id: 'pressure_solid', label: 'Solid Pressure', symbol: 'P', formula: 'P = F/A' },
    { id: 'pressure_liquid', label: 'Liquid Pressure', symbol: 'ρ', formula: 'P = ρgh' },
  ];
        ...
        >
          ...
          <InputCard style={isTablet && styles.tabletInputCard}>
            ...
            <Text style={styles.sectionLabel}>
              {mode === 'pressure_solid' ? 'Force & Area' : 'Fluid Properties'}
            </Text>
          ...
          {result && (
            <View style={styles.solutionArea}>
              ...
              <FinalAnswer label="💧 Pressure Result" shareText={result.shareText}>
